...
$uri_whitelist = array(
    ...
    '/sharepoint/sharepoint-to-clarity-integration-suite/',
    '/sharepoint/sharepoint-to-clarity-document-collaboration-and-portlets/',
    '/sharepoint/bi-directional-timesheet-integration/',
    '/sharepoint/bi-directional-task-and-scrum-clarity-integration/',
    '/events/',
    '/events/page/1/',
    '/events/page/2/',
    '/events/page/3/',
