<?php
/*
Template Name Posts: PPM TimesheetBoss
*/
get_header(); ?>
...
//jQuery("html, body").animate({ scrollTop: 127 }, 600);
  ...
  <div class="content_sharepoint">
        ...
        <strong>Clarity <> SharePoint <> Security <> MS Exchange <> Outlook <> Mobile</strong>
        </div>
        <div class="timesheet_background">
        <div class="an1_timesheet">
        <span><strong></strong></span>
        </div>
        <div class="an2_timesheet">
        <span>Enter time data via Microsoft&nbsp;<br>
        Outlook, SharePoint, or any&nbsp;<br>
        mobile device, and always&nbsp;<br>
        be in sync with Clarity.</span>
        <div><br>
        </div>
        <span>&nbsp;</span>
        </div>
        <div class="an3_timesheet">
        <span>&nbsp;</span>
        </div>
        <div class="an4_timesheet">
        <span>&nbsp;</span>
        </div>
        <div class="an5_timesheet">
        <span>With no need to deploy and maintain&nbsp;<br>
        new apps. &nbsp;Everyone already has an app&nbsp;<br>
        on their mobile device that connects to&nbsp;<br>
        Exchange to enter time.</span>
        </div>
        <div class="an7_timesheet">
        <span>&nbsp;</span>
        </div>
        <div class="an8_timesheet">
        <span><span style="color: #f2f2f2;"><br>
        </span></span>
        <div><span style="color: #f2f2f2;"><br>
        </span></div>
        <span>&nbsp;</span>
        </div>
        <div class="an9_timesheet">
        <span>&nbsp;</span>
        <div><br>
        </div>
        <span>&nbsp;</span>
        </div>
        <div class="an6_timesheet">
        <span>&nbsp;</span>
        </div>
        </div>
       ...
       <!-- ********************************* 
        ...
        <h1 style="font-size: 3em;font-weight: bold;text-align: center;"><?php echo get_field("title-3"); ?></h1>
        </div>
        <?php } ?>
...
?></a>
        ...
        <div class="assignmet_boss_text"><p>
        <?php $cont=get_field("footer_text");
echo trim($cont);?>
