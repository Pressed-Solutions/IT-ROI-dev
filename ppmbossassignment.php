<?php
/*
Template Name Posts: PPM assignmentBoss
*/
get_header(); ?>
...
//jQuery("html, body").animate({ scrollTop: 127 }, 600);
  ...
  <div class="content_sharepoint">
        ...
        <strong>Multi-project resource planning and utilization analysis via SharePoint</strong>
        </div>
        <div class="assignment_background">
        <div class="an1_assignment">
        <span><strong></strong><span style="color: #ffffff;">Create &amp; Edit<br>
        Assignments<br>
        Dynamically</span><br>
        <br>
        </span>
        </div>
        <div class="an2_assignment">
        <span>Provides enterprise visibility<br>
        to your projects without<br>
        having to login to Clarity</span>
        </div>
        <div class="an3_assignment">
        <span>PM's&nbsp;<br>
        become&nbsp;<br>
        SharePoint<br>
        Admins</span>
        </div>
        <div class="an4_assignment">
        <span>Integrated team&nbsp;<br>
        and/or collaboration&nbsp;<br>
        security from Clarity&nbsp;<br>
        to SharePoint</span>
        </div>
        <div class="an5_assignment">
        <span>Create new&nbsp;<br>
        Assignments<br>
        with Drag&nbsp;<br>
        &amp; Drop<br>
        ...
        <div class="an7_assignment">
        <span>Real-time<br>
        display of<br>
        resource<br>
        utilization</span>
        </div>
        <div class="an8_assignment">
        <span>No tool<br>
        change<br>
        required</span>
        <div><br>
        ...
        <div class="an9_assignment">
        <span>Edit on a<br>
        weekly, monthly,<br>
        or yearly basis<br>
        for all projects</span>
        <div><br>
        </div>
        <p>&nbsp;</p>
        </div>
        <div class="an6_assignment">
        ...
        <?php } ?>
            ...
            ?>
             ...
             <?php } ?>
                     ...
                     <div class="PPM_Boss_sharepoint_cont" style="">
            <?php    $id=$post->ID;
