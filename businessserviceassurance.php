<?php
/*
  Template Name Posts: Business Service Assurance
 */
get_header();
?>
    ...
    <?php the_content(); ?>
            ...
            <div class="internal_out_sidebar">
                ...
                <div class="innner_page_sidebar"> 
                    ...
                    <?php
                    $taxonomy = 'console';
//$terms = get_terms($taxonomy, 'slug=service-assurance');
//if ($terms) {
...
//}
                    ?>
                    <a href="<?php get_site_url(); ?>/casolution/service-assurance/">
                        <?php
                ...
                <div class="internal_contact">
                    <?php dynamic_sidebar('business_service_assurance'); ?>
                </div>
            </div>
