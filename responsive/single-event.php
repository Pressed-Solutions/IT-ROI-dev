        ...
        <div class="col-md-8 main-tt maincon">
                            ...
                            <h2 class="page-header">
                                Events                            </h2>
                                                        ...
                                                        <p>We are on a missin to make PPM simpler, and we're telling the world.<br>
...
<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
				<div class="evt-post" id="post-<?php the_ID(); ?>"> <div class="col-md-3 evt-thumbnail">
				<?php if ( has_post_thumbnail()) : ?>
		 ...
		 <div class="col-md-9 evt-content"><a href="<?php echo get_permalink(); ?>" ><div class="evt-title"><?php the_title(); ?></div></a>
			...
			<div class="register-button"><a href="#" >Register Now</a></div><?php the_content(); ?></div><div class="clear"></div></div>
<?php endwhile; ?>
