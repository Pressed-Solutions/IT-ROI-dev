...
////////////////////////////////////////////////////////////////////
    ...
    function theme_options_menu() {
        add_theme_page( 'DevDm Theme' . __('Options','pressedsolutions'), 'Pressed Solutions' . __('Options','pressedsolutions'), 'manage_options', 'devdm-theme-options', 'devdm_theme_options' );
    }
    ...
    function toolbar_link_to_mypage( $wp_admin_bar ) {
        $args = array(
            ...
            'title' => __('Pressed Solutions Options','pressedsolutions'),
    ...
    if ( !current_user_can( 'manage_options' ) )  {
        ...
        $logo = get_template_directory_uri() . '/img/logo.png'; ?>
           <div class="wrap">
            ...
            <h2><a href="<?php echo $developer_uri ?>" target="_blank">Pressed Solutions - Maintained by PressedSolutions.com</a></h2>
            ...
            <div class='saved'><p><strong><?php _e('Options Saved!','pressedsolutions') ;?></strong></p></div>
        <?php endif; ?>
        ...
        <form action="options.php" method="post">
            ...
            <table cellpadding='10'>
                ...
                <tr valign="top"><th scope="row"><?php _e('Right Sidebar','pressedsolutions') ;?></th>
                    <td>
                        <input type="checkbox" id="right_sidebar" name="dm_options[right_sidebar]" value="1" <?php checked( true, $settings['right_sidebar'] ); ?> />
                        <label for="right_sidebar"><?php _e('Show the Right Sidebar','pressedsolutions') ;?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e('Right Sidebar Size','pressedsolutions') ;?></th>
                    <td>
                ...
                <tr valign="top"><th scope="row"><?php _e('Left Side Bar','pressedsolutions') ;?></th>
                    <td>
                        <input type="checkbox" id="left_sidebar" name="dm_options[left_sidebar]" value="1" <?php checked( true, $settings['left_sidebar'] ); ?> />
                        <label for="left_sidebar"><?php _e('Show the Left Sidebar','pressedsolutions') ;?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e('Left Sidebar Size','pressedsolutions') ;?></th>
                    <td>
                        <?php foreach( $dm_sidebar_sizes as $sizes ) : ?>
                ...
                <tr valign="top"><th scope="row"><?php _e('Show Header','pressedsolutions') ;?></th>
                    <td>
                        <input type="checkbox" id="show_header" name="dm_options[show_header]" value="1" <?php checked( true, $settings['show_header'] ); ?> />
                        <label for="show_header"><?php _e('Show The Main Header in the Template (logo/sitename/etc.)','pressedsolutions') ;?></label>
                    </td>
                </tr>
                <tr valign="top"><th scope="row"><?php _e('Show Post Meta','pressedsolutions') ;?></th>
                    <td>
                        <input type="checkbox" id="show_postmeta" name="dm_options[show_postmeta]" value="1" <?php checked( true, $settings['show_postmeta'] ); ?> />
                        <label for="show_postmeta"><?php _e('Show Post Meta data (author, category, date created)','pressedsolutions') ;?></label>
                    </td>
                </tr>
            ...
            <p class="submit">
                <input name="Submit" type="submit" class="button-primary" value="<?php esc_attr_e('Save Changes','pressedsolutions'); ?>" />
            </p>
