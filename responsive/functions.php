...
function display_cta_buttons( $atts ) {
    ...
    $cta_string .= '<div class="col-md-3"><a class="background-purple">' . get_post_meta( get_the_ID(), 'download_the_product_brief ' ) . 'Download the product brief</a></div>';
    $cta_string .= '<div class="col-md-3"><a class="background-red">' . get_post_meta( get_the_ID(), 'replay_the_webinar ' ) . 'Replay the webinar</a></div>';
