...
function display_cta_buttons( $atts ) {
    ...
    $cta_string .= '<div class="col-md-3"><a class="background-purple">' . get_post_custom_values( 'download_the_product_brief ' ) . 'Download the product brief</a></div>';
    $cta_string .= '<div class="col-md-3"><a class="background-red">' . get_post_custom_values( 'replay_the_webinar ' ) . 'Replay the webinar</a></div>';
    $cta_string .= '<div class="col-md-3"><a class="background-blue">' . get_post_custom_values( 'request_a_demo ' ) . 'Request a demo</a></div>';
