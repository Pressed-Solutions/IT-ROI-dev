<?php
/*
Template Name Posts: PPM taskBoss
*/
get_header(); ?>
...
//jQuery("html, body").animate({ scrollTop: 127 }, 600);
  ...
  <div class="content_sharepoint">
        ...
        <div class="an5_task">
        <span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Everyone in your&nbsp;<br>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;organization has&nbsp;<br>
        an app on their mobile<br>
        ...
        <div class="an9_task">
        <span>PPM task/scrumBoss provides entry&nbsp;<br>
        into a Scrum view via SharePoint&nbsp;<br>
        to manage tasks in Clarity</span>
        <div><br>
        </div>
        <span>&nbsp;</span>
        </div>
       ...
       <!-- ********************************* 
        ...
        <?php if(get_field("task_management_title")!="")
            {
            ?>
        <div style="margin-top: 45px;">
        <h1 style="font-size: 2.7em;text-align: center;"><?php echo get_field("task_management_title"); ?></h1>
        </div>
        <?php } ?>
        
       <div class="PPM_Boss_products">
            <?php if(get_field("task_management_image")!="")
                {
                    ?>
                     <img  src="<?php echo trim(get_field("task_management_image"));?>"/>
             <?php } ?>
