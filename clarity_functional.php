<?php
/*
  Template Name Posts: clarity functional
 */
get_header();
?>
<?php while (have_posts()) : the_post(); ?>
    ...
    <?php the_content(); ?>
            ...
            <div class="internal_out_sidebar" style="">
                ...
                <div class="innner_page_sidebar"> 
                    ...
                    <?php $pageurl = get_permalink_by_slug($slug = 'clarity', $post_type = 'casolution'); ?>
